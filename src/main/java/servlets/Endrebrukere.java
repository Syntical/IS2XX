...
@WebServlet(name = "Endrebrukere", urlPatterns = {"/Endrebrukere"})
public class Endrebrukere extends AbstractAppServlet {
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        writeResponse(request, response, "Endre bruker!");
    }
    ...
    protected void writeBody(HttpServletRequest req, PrintWriter out) {
        ...
        String bkn = req.getParameter("bkn");
        String em = req.getParameter("em");
        String pkn = req.getParameter("pkn");
        String gg = req.getParameter("gg");


        if (action.contains("endre brukernavn")) {
            LoginRepo.byttBN(bkn, em, out );
            out.println("brukernavnet har blitt endret");
        }
        else if (action.contains ("endre passord")) {
            LoginRepo.byttPass(pkn, gg, out);
            out.println("Passordet har blitt endret");
