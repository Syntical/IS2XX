...
import tools.repository.Connectrepo;
...
@WebServlet(name = "rotetable", urlPatterns = {"/rotetable"})
public class Rotetable extends AbstractAppServlet {
    /**
    ...
    protected void writeBody(HttpServletRequest req, PrintWriter out) {
        ...
        String dd = req.getParameter("cb");
        String aa = req.getParameter("ci");

        if (action.contains("change")) {
            Connectrepo.leggtilalt(dd, aa, out);
            out.println("alt funker");
        }
