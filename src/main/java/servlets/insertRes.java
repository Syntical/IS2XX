...
public class insertRes extends AbstractAppServlet {
    /**
    ...
    protected void writeBody(HttpServletRequest req, PrintWriter out) {
        ...
        String uutid = req.getParameter("uutid");
        String tsstid = req.getParameter("tsstid");
        ...
        if (action.contains("legg til resultat")) {
            ...
            UtoeverRepo.testres(utoever, uutid, tsstid, out);
        }
