...
public class UtoverPeriodeModel {
     ...
     */
    public UtoverPeriodeModel(String fornavn, String etternavn, String fodselsdato, String hoyde, String vekt, String femtusen_watt, String femtusen_tid, String tretusen_sek, String tretusen_tid, String tretusen_lop_tid, String totusen_watt, String totusen_tid, String seksti_watt,
                              String kropps_hev_stk, String Sargeant_stk, String beveg_stk, String ligg_ro, String ligg_ro_pst, String ligg_ro_kg, String kneboy_pst, String kneboy_kg, String totalscore, String testuke, String ar) {
        ...
        this.testuke = Integer.parseInt(testuke);
        this.ar = ar;
    ...
    public int getTestuke() { return testuke; }

    public void setTestuke(int testuke) { this.testuke = testuke; }
